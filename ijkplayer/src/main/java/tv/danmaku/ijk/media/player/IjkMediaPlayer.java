...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private OnControlMessageListener2 mOnControlMessageListener;
    public void setOnControlMessageListener(OnControlMessageListener2 listener) {
        mOnControlMessageListener = listener;
    }

    public interface OnControlMessageListener2 {
    ...
    private static boolean onNativeInvoke(Object weakThiz, int what, Bundle args) {
        ...
        switch (what) {
            case OnNativeInvokeListener.ON_CONCAT_RESOLVE_SEGMENT: {
                OnControlMessageListener2 onControlMessageListener = player.mOnControlMessageListener;
    ...
    public interface OnMediaCodecSelectListener2 {
        String onMediaCodecSelect(IMediaPlayer mp, String mimeType, int profile, int level);
    }
    private OnMediaCodecSelectListener2 mOnMediaCodecSelectListener;
    public void setOnMediaCodecSelectListener(OnMediaCodecSelectListener2 listener) {
    ...
    private static String onSelectCodec(Object weakThiz, String mimeType, int profile, int level) {
        ...
        OnMediaCodecSelectListener2 listener = player.mOnMediaCodecSelectListener;
        if (listener == null)
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener2 {
