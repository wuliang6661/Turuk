...
public class GiraffePlayer {
    ...
    private final View.OnClickListener onClickListener=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (v.getId() == R.id.shopBtn){//商品
                onSendMessListener.clickProduct();
            } else if (v.getId() == R.id.rlSend){//发言
                onSendMessListener.clickInput();
            } else if (v.getId() == R.id.shareBtn){//分享
                onSendMessListener.shareClick();
            } else if (v.getId() == R.id.likeBtn){//点赞
                onSendMessListener.clickLike();
            }
        }
    };
    ...
    private void showBottomControl(boolean show) {
        ...
        if (getScreenOrientation() == ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) {
            $.id(R.id.bottomLayout).gone();
            onScreenChangeListener.change(false);
        } else {
            $.id(R.id.bottomLayout).visible();
            onScreenChangeListener.change(true);
        }
    }
...
//                        Toaster.show("download rate:" + extra);
        ...
        $.id(R.id.shopBtn).clicked(onClickListener);
        $.id(R.id.rlSend).clicked(onClickListener);
        $.id(R.id.shareBtn).clicked(onClickListener);
        $.id(R.id.likeBtn).clicked(onClickListener);
    ...
    public void setShowNavIcon(boolean show) {
        $.id(R.id.app_video_finish).visibility(show ? VISIBLE : View.GONE);
    }
...
//                }
                if (distanceX > 0) {
                    ...
                    $.id(R.id.bottomLayout).visible();
                    $.id(R.id.app_video_play).animationIn();
                    $.id(R.id.app_video_currentTime).animationIn();
                    $.id(R.id.app_video_endTime).animationIn();
                    $.id(R.id.app_video_seekBar).animationIn();
                    $.id(R.id.app_video_bottom_box).animationIn();
                    $.id(R.id.bottomLayout).animationIn();
                    onSendMessListener.removeView(false);
                }else {
                    $.id(R.id.app_video_play).invisible();
                    $.id(R.id.app_video_currentTime).invisible();
                    $.id(R.id.app_video_endTime).invisible();
                    $.id(R.id.app_video_seekBar).invisible();
                    $.id(R.id.app_video_bottom_box).invisible();
                    $.id(R.id.bottomLayout).invisible();
                    $.id(R.id.app_video_play).animationOut();
                    $.id(R.id.app_video_currentTime).animationOut();
                    $.id(R.id.app_video_endTime).animationOut();
                    $.id(R.id.app_video_seekBar).animationOut();
                    $.id(R.id.app_video_bottom_box).animationOut();
                    $.id(R.id.bottomLayout).animationOut();
                    onSendMessListener.removeView(true);
                }
            } else {
    ...
    public interface OnSendMessListener{
        void clickInput();
        void clickProduct();
        void clickLike();
        void shareClick();
        void removeView(boolean show);
    }

    public interface OnScreenChangeListener{
        void change(boolean land);
    }
    ...
    public GiraffePlayer onSendMessListener(OnSendMessListener listener){
        this.onSendMessListener = listener;
        return this;
    }

    public GiraffePlayer onScreenChangeListener(OnScreenChangeListener listener){
        this.onScreenChangeListener = listener;
        return this;
    }
    private OnSendMessListener onSendMessListener =new OnSendMessListener() {
    ...
    private OnScreenChangeListener onScreenChangeListener = new OnScreenChangeListener() {
        @Override
        public void change(boolean land) {
