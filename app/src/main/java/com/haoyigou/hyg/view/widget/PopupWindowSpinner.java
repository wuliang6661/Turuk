...
public class PopupWindowSpinner extends TextView {
   ...
   // private Drawable mDrawable;
    ...
    public PopupWindowSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public PopupWindowSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public PopupWindowSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = resources.getDimensionPixelSize(R.dimen.popup_text);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.RIGHT);
        setPadding(resources.getDimensionPixelSize(R.dimen.popup_text), defaultPadding, defaultPadding,
            defaultPadding);
        setClickable(true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        mPopup.setWidth(MeasureSpec.getSize(widthMeasureSpec)*2);
