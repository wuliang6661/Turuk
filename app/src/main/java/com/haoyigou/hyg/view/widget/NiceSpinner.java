...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            mPopup.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.drop_down_arrow));
        }
        ...
        if (!mHideArrow) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.drop_down_arrow);
