...
package com.haoyigou.hyg.view.zxing.camera;
...
public final class CameraManager {
    ...
    private static final int MIN_FRAME_WIDTH = GlobalApplication.screen_width * 2 / 3;
    private static final int MIN_FRAME_HEIGHT = GlobalApplication.screen_width * 2 / 3;
