...
public class AvatarImageView extends ImageView {
    ...
    public void init() {
        ...
        fileSavePath = Environment.getExternalStorageDirectory()
                .getAbsolutePath() + "/xibao/cache/photoes/";
        // 判断是否挂载了SD卡
        ...
        super.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ContextCompat.checkSelfPermission(fragment.getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED) {
                    ...
                    ActivityCompat.requestPermissions(fragment.getActivity(), new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_EXTERNAL_STORAGE_REQUEST_CODE);
                }
