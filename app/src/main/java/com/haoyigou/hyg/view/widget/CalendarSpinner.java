...
public class CalendarSpinner extends TextView {
    ...
    public CalendarSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        conn = context;
        init(context, attrs);
    }

    public CalendarSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
