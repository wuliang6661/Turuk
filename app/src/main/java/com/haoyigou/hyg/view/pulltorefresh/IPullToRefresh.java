...
public interface IPullToRefresh<T extends View> {
     ...
     */
    com.haoyigou.hyg.view.pulltorefresh.PullToRefreshBase.Mode getCurrentMode();
     ...
     */
    void setOnRefreshListener(com.haoyigou.hyg.view.pulltorefresh.PullToRefreshBase.OnRefreshListener<T> listener);
