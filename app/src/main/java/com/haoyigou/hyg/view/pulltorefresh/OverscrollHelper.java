...
public final class OverscrollHelper {
     ...
     */
    public static void overScrollBy(final com.haoyigou.hyg.view.pulltorefresh.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
    ...
    public static void overScrollBy(final com.haoyigou.hyg.view.pulltorefresh.PullToRefreshBase<?> view, final int deltaX, final int scrollX,
        ...
        if (view.isPullToRefreshOverScrollEnabled() && !view.isRefreshing()) {
            ...
            if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
                ...
                if (com.haoyigou.hyg.view.pulltorefresh.PullToRefreshBase.DEBUG) {
