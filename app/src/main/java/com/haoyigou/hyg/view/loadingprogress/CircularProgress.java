package com.haoyigou.hyg.view.loadingprogress;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.pro_red);
        mColors[1] = context.getResources().getColor(R.color.pro_yellow);
        mColors[2] = context.getResources().getColor(R.color.pro_green);
        mColors[3] = context.getResources().getColor(R.color.pro_blue);
