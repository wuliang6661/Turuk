...
public class PackageUtils {
    ...
    /**
     * Installation return code<br/>
     * the package manager FloatViewService found that the device didn't have enough
     ...
     * package and the caller has not supplied the {@link #INSTALL_FAILED_TEST_ONLY}
     * flag.
     */
