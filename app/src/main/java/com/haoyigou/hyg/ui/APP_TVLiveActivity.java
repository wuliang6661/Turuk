...
public class APP_TVLiveActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_live_app_tv);
    ...
    private void setLiveAdapter() {
        LGRecycleViewAdapter<TVLiveEntry> adapter = new LGRecycleViewAdapter<TVLiveEntry>(live) {
            ...
            public void convert(LGViewHolder holder, TVLiveEntry tvLiveEntry, int position) {
                ...
                Glide.with(APP_TVLiveActivity.this).load(tvLiveEntry.getLogopic()).into(liveImg);
        ...
        adapter.setOnItemClickListener(R.id.item_layout, new LGRecycleViewAdapter.ItemClickListener() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                Intent intent = new Intent(APP_TVLiveActivity.this, HomeWebViewAct.class);
...
//        tvTitle.setText("提示");
        ...
        final MyDialog builder = new MyDialog(APP_TVLiveActivity.this,0,0,view,R.style.DialogTheme);
    ...
    private void setShopAdapter() {
        CommonAdapter<ShopEntry> adapter = new CommonAdapter<ShopEntry>(this, R.layout.item_shop_layout, shop) {
            ...
            protected void convert(ViewHolder viewHolder, ShopEntry item, int position) {
                ...
                params.height = (int) (DisplayUtil.getMobileWidth(APP_TVLiveActivity.this) / 1.83);
                shopLayout.setLayoutParams(params);
                Glide.with(APP_TVLiveActivity.this).load(item.getPiclogo2()).into(shopImg);
